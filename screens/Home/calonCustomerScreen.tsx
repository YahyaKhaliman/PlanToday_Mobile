    ...
    try {
      ...
      Toast.show({
        ...
        text2:
          ...
          'Gagal mengambil rekap calon customer',
      });
      setData([]);
    } finally {
      setLoading(false);
        ...
        <TouchableOpacity activeOpacity={0.9} onPress={() => openEdit(item)}>
          <View style={styles.cardCompact}>
            <View style={{ flex: 1 }}>
              ...
              <View
                style={[styles.inlineRow, { marginTop: 6, flexWrap: 'wrap' }]}
              >
    ...
    >
      ...
      {showFab && (
        <TouchableOpacity
          activeOpacity={0.9}
          onPress={() =>
            runGuardedPress('calon:open-filter', () => setOpenFilter(true), 250)
          }
          ...
          <View style={styles.modalCard}>
            ...
            <View style={[styles.row2, { marginTop: 14 }]}>
              <TouchableOpacity
                ...
                onPress={() => {
                  runGuardedPress('calon:modal-refresh', () => {
                    setOpenFilter(false);
                    refreshRekap();
                  });
                }}
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  runGuardedPress('calon:modal-wa', () => {
                    setOpenFilter(false);
                    kirimWA();
                  });
                }}
      ...
      >
        <TouchableOpacity
          ...
          onPress={() =>
            runGuardedPress('calon:go-add', () =>
              navigation.navigate('CalonCustomer'),
            )
          }
          activeOpacity={0.9}
        >
        ...
        <TouchableOpacity
          ...
          onPress={() => runGuardedPress('calon:refresh', handleRefresh)}
          disabled={loading}
          activeOpacity={0.9}
        >
          {loading ? (
        ...
        <TouchableOpacity
          ...
          onPress={() => runGuardedPress('calon:wa', kirimWA)}
          disabled={loading}
          activeOpacity={0.9}
        >
